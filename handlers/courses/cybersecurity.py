...
@dp.message_handler(commands='cybersecurity')
async def cybernation_com(message: types.Message):
    ...
    next_suggest = ("Agarda siz CyberSecurity kursi haqida ma'lumotni <b>video shaklida</b> ko'rmoqchi bo'lsangiz /cybersecurity_video buyrug'ini bering")
    await message.answer(next_suggest)


@dp.message_handler(commands='cybersecurity_video')
